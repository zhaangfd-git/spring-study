...
import com.zhangfd.spring.context.ApplicationListener;
...
class ApplicationListenerDetector implements DestructionAwareBeanPostProcessor, MergedBeanDefinitionPostProcessor {
	...
	// 这里是把所有ApplicationListener接口的实现类 并且一定是单例模式的，使用spring创建完对象后，
	//反过来也把该实现类通知容器，保存在AbstractApplicationContext 的Set<ApplicationListener<?>> applicationListeners
	@Override
