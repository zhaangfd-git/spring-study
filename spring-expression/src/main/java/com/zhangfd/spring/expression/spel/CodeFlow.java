...
import com.zhangfd.spring.asm.ClassWriter;
...
public class CodeFlow implements Opcodes {
    ...
    @Nullable
    private List<CodeFlow.FieldAdder> fieldAdders;
    @Nullable
    private List<CodeFlow.ClinitAdder> clinitAdders;
    ...
    public void finish() {
        if (this.fieldAdders != null) {
            ...
            while(var1.hasNext()) {
                CodeFlow.FieldAdder fieldAdder = (CodeFlow.FieldAdder)var1.next();
        ...
        if (this.clinitAdders != null) {
            ...
            while(var5.hasNext()) {
                CodeFlow.ClinitAdder clinitAdder = (CodeFlow.ClinitAdder)var5.next();
