...
public abstract class Operator extends SpelNodeImpl {
    ...
    protected static final class DescriptorComparison {
        static final Operator.DescriptorComparison NOT_NUMBERS = new Operator.DescriptorComparison(false, false, ' ');
        static final Operator.DescriptorComparison INCOMPATIBLE_NUMBERS = new Operator.DescriptorComparison(true, false, ' ');
        ...
        public static Operator.DescriptorComparison checkNumericCompatibility(@Nullable String leftDeclaredDescriptor, @Nullable String rightDeclaredDescriptor, @Nullable String leftActualDescriptor, @Nullable String rightActualDescriptor) {
            ...
            if (leftNumeric && rightNumeric) {
                return CodeFlow.areBoxingCompatible(ld, rd) ? new Operator.DescriptorComparison(true, true, CodeFlow.toPrimitiveTargetDesc(ld)) : INCOMPATIBLE_NUMBERS;
            } else {
                return NOT_NUMBERS;
            }
        }
