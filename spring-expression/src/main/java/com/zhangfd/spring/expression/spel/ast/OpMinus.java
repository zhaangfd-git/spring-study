        ...
        if (this.children.length < 2) {
            ...
            if (operand instanceof Number) {
                if (operand instanceof BigDecimal) {
                    ...
                    return new TypedValue(0.0D - ((Number)operand).doubleValue());
                    ...
                    return operand instanceof Byte ? new TypedValue(0 - ((Number)operand).byteValue()) : new TypedValue(0.0D - ((Number)operand).doubleValue());
                }
            } else {
