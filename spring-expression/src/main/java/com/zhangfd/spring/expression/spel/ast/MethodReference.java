...
import com.zhangfd.spring.expression.spel.support.ReflectiveMethodExecutor;
import com.zhangfd.spring.expression.spel.support.ReflectiveMethodResolver;
...
public class MethodReference extends SpelNodeImpl {
	...
	private void throwSimpleExceptionIfPossible(Object value, AccessException ex) {
		if (ex.getCause() instanceof InvocationTargetException) {
			...
			throw new EvaluationException(getStartPosition(),
